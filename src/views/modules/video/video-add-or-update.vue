      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="片长" prop="duration">
            <el-input placeholder="片长" v-model="video.duration" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="评分">
            <el-rate v-model="video.score" allow-half style="line-height: 2" ></el-rate>
          </el-form-item>
        </el-col>
      </el-row>
  ...
  methods: {
    init () {
      ...
      this.$http({
        ...
        this.url = this.$http.adornUrl(`/manage/file/resource/minio/upload?token=${this.$cookie.get('token')}&fileModule=1`)
