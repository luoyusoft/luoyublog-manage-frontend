...
//
//   $.ajax({
//     url: 'http://127.0.0.1:8080/upload/init-chunk-upload',
//     type: 'POST',
...
//  * @param fileName
//  */
// export function composeFile (fileMd5, fileName) {
//   console.log('开始请求后端合并文件')
//   // 注意：bucketName请填写你自己的存储桶名称，如果没有，就先创建一个写在这
//   const composeParams = JSON.stringify({fileMd5: fileMd5, fileName: fileName, bucketName: 'img-library'})
//   $.ajax({
//     url: 'http://127.0.0.1:8080/upload/compose-file',
//     type: 'post',
//     contentType: 'application/json',
//     processData: false,
//     data: composeParams,
...
//  * @param suffix
//  */
// export function videoPlay (url, suffix) {
